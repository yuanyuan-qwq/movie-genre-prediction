      ...
      return Row(
        ...
        children: <Widget>[
          if (message['sender'] == 'Bot')
            CircleAvatar(
                backgroundImage: AssetImage('images/chatbot_logo.jpeg')),
          Flexible(
            child: Container(
          ...
          if (message['sender'] == 'User')
            CircleAvatar(backgroundImage: AssetImage('images/userLogo.png')),
        ],
      );
    }).toList();
  }
